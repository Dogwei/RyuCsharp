...
partial class Ryu
{
    ...
    static int to_chars(floating_decimal_32 v, bool sign, ref char result)
    {
        ...
        {
            Unsafe.Add(ref result, index) = (char)('0' + output);
        }
    ...
    public static int f2s_buffered_n(float f, ref char result)
    {
    ...
    public static void f2s_buffered(float f, ref char result)
    {
        int index = f2s_buffered_n(f, ref result);
